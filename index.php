  ...
  <form action="authentication.php" method="post">
    <div class="content">
      <div class="card mt-5 mb-5">
        <p class="text-center title my-5">Login</p>
        ...
        <div class="card-body mx-3">
          ...
          <div class="text-center">
            <button class="btn1 btn-block my-4 py-3" type="submit" name="login">Login</button>
          </div>

          <p class="text-center mt-5" style="color: black; font-size: 16px;">Don't have an account?<a href="register.php"><span style="color: #1EE06C;"> Register</span></a></p>
